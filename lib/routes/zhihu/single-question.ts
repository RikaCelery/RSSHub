...
export const route: Route = {
    ...
    example: '/zhihu/single-question/264051433',
...
async function handler(ctx): Promise<Data> {
    ...
    header.set('Referer', `https://www.zhihu.com/question/${questionId}`);
    const response = await got.get(`https://www.zhihu.com/question/${questionId}`, {
        headers: {
    ...
    return {
        ...
        // author:question.author.headline + '@' + question.author.name,
